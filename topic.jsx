                ...
                <div className="menu-drawer-categories">
                  ...
                  <div className="drawer-category">
                    ...
                    <div className="drawer-category-links">
                      ...
                      <a href="topic.html" className="drawer-category-link" onClick={() => setMenuOpen(false)}>World Economy</a>
                    </div>
                  </div>
                  <div className="drawer-category">
                    ...
                    <div className="drawer-category-links">
                      ...
                      <a href="topic.html" className="drawer-category-link" onClick={() => setMenuOpen(false)}>Marxist Economics</a>
                    </div>
                  </div>
                  <div className="drawer-category">
  ...
  return (
    <div className="site">
      <div className="site-header">
        ...
        <Nav active="Theory & History" onSelect={() => {}} onOpenMenu={() => setMenuOpen(true)} />
      </div>
