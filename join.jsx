...
function JoinForm() {
  ...
  if (submitted) {
    return (
      <section className="join-form-wrap join-form-wrap--success rci-tex-laid" id="join-form">
        ...
        <div className="join-form-body" style={{ padding: "40px 40px 48px" }}>
          <p style={{ fontFamily: "var(--rci-font-serif-display)", fontSize: 19, lineHeight: 1.5, color: "var(--rci-ink)", maxWidth: "52ch", margin: "0 0 22px" }}>
  ...
  return (
    <section className="join-form-wrap rci-tex-laid" id="join-form">
